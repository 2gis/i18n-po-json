...
export const panic: typeof _panicImpl = (s: string, invalidStrings: string[]) => panicImpl(s, invalidStrings);
export const warning: typeof _warningImpl = (s: string, invalidStrings: string[]) => warningImpl(s, invalidStrings);
export function overridePanic(cb: (message: string, invalidStrings: string[]) => void = _panicImpl) {
  panicImpl = cb;
}
export function overrideWarning(cb: (message: string, invalidStrings: string[]) => void = _warningImpl) {
  warningImpl = cb;
}
